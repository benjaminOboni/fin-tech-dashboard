...
import Statistics from "./center side/Statistics";

function Content() {
  return (
    <div className="w-full h-[900vh] space-x-4 items-center grid grid-cols-2 xl:grid-cols-3">
      {/* left section */}
      <div className="items-center justify-center flex flex-col col-span-2 h-full py-2 px-3 w-full space-y-4">
        ...
        <div className="pb-1 pt-12 px-3 w-full h-full space-y-8">
          ...
          <div className="pb-2 pt-4 px-3 items-center justify-center grid grid-cols-2 xl:grid-cols-4 w-full">
            ...
            <div
              className="py-3 px-3 w-full xl: col-span-3 col-span-2 xl:flex items-center justify-between xl:space-y-0
            space-y-4 xl:space-x-4"
            >
          ...
          <div className="px-3 w-full items-center justify-center flex">
            <div
              className="py-4 px-6 w-full items-center justify-between xl:space-y-0 space-y-6
            lg:flex bg-[#F8F8F8] rounded-lg"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="lg:w-1/2 w-full items-start justify-start lg:items-end lg:justify-end flex lg:space-x-4">
                ...
                <button
                  className="bg-black smooth hover:bg-gray-100 hover:text-gray-900 hover:border-gray-900 text-gray-100
                py-3 px-8  border border-transparent rounded-md"
                >
                  Pay
                </button>
              </div>
